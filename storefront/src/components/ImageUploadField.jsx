...
// customer's AvatarUrl. Mirrors tenant-admin's ImageUploadField.
        ...
        <Box>
            ...
            <Box
                ...
                onKeyDown={(event) => {
                    ...
                    // real <button> whose own Enter/Space keydown bubbles up
                    // to this handler too - without the check, that would
                    // also reopen the file picker on top of its own click.
